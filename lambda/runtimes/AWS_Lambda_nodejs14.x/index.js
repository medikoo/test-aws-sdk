...
let errorCallbacks = {
	uncaughtException: error => { client.postInitError(error, () => process.exit(129)); },
	unhandledRejection: error => { client.postInitError(error, () => process.exit(128)); }
};
...
const handler = UserFunction.load(process.env.LAMBDA_TASK_ROOT, process.env._HANDLER);
