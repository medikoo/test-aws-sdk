...
module.exports = class InvokeContext {
	constructor(headers) { this.headers = _enforceLowercaseKeys(headers); }
	 ...
	 */
	updateLoggingContext() { setCurrentRequestId(this.invokeId); }
	...
	_headerData() {
		...
		return {
			...
			getRemainingTimeInMillis: function () { return deadline - Date.now(); }
		};
	}
